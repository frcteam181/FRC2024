...
public class awesomeampshot extends Command {
    ...
    public void initialize() {
        System.out.println("AWESOME AMP! Pre Load Only Started");
    ...
    public void execute() {
        ...
        if(m_arm.isArmSafe() && !m_setWrist) {m_wrist.setGoal(kBACK_AMP_PRESET.kWristPos); m_setWrist = true;}
